...
// The owner of Student object: joe --> Student {name: "Joe", age: "Schmoe", hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
// The window object --> Window {window: Window, self: Window, document: document, name: "", location: Location, …}
// 3. Explain why "this" is different when an arrow function is used.
// 'this' refers to the enclosing scope, when using it inside a constructor it will refer to the current object, but when using it inside an arrow function and there isn't any surrounding functional scope 'this' will refer to the global window object.
