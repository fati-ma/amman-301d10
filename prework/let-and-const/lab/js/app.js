...
function displayPics(){
  ...
  // 'let' is block-scoped, it can't be used outside its scope, therefore, using the variable 'rando' that is declared using 'let' outside its scope which is 'the while loop' will cause an error.
